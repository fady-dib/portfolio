            ...
            <section id="home" className="common-bg ">
                <div className="shadow-md shadow-gray-400 z-1000 bg-[#214655] relative text-white">
                    ...
                    <div className={`absolute top-[110px] left-0 right-0 lg:hidden flex flex-col items-start custom:items-center bg-white text-[16px] shadow-lg z-50 text-[#214959]
                        ...
                        <p className="inter-medium w-full pl-6 custom:w-auto custom:pl-0 custom:hover:bg-white h-[60px] flex items-center  hover:bg-gray-100 transition-all duration-300 border-b border-gray-200 custom:border-none"><span onClick={() => window.location.reload()} className="cursor-pointer hover:opacity-55 transition-all duration-300">HOME</span></p>
                        <p className="inter-medium w-full pl-6 custom:w-auto custom:pl-0 custom:hover:bg-white h-[60px] flex items-center  hover:bg-gray-100 transition-all duration-300 border-b border-gray-200 custom:border-none"><span onClick={() => scrollToSection('about')} className="cursor-pointer hover:opacity-55 transition-all duration-300">ABOUT</span></p>
                        <p className="inter-medium w-full pl-6 custom:w-auto custom:pl-0 custom:hover:bg-white h-[60px] flex items-center  hover:bg-gray-100 transition-all duration-300 border-b border-gray-200 custom:border-none"><span onClick={() => scrollToSection('projects')} className="cursor-pointer hover:opacity-55 transition-all duration-300">PROJECTS</span></p>
                        <p className="inter-medium w-full pl-6 custom:w-auto custom:pl-0 custom:hover:bg-white h-[60px] flex items-center  hover:bg-gray-100 transition-all duration-300"><span onClick={() => scrollToSection('contact')} className="cursor-pointer hover:opacity-55 transition-all duration-300">CONTACT</span></p>
                    </div>
                </div>
