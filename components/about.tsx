        ...
        <dl className="mt-16 grid gap-5 md:grid-cols-3">
          {stats.map((stat, index) => (
            <Reveal key={stat.title} delay={index * 100}>
              <div className="group relative h-full overflow-hidden rounded-card border border-glass-edge bg-glass p-7 shadow-card backdrop-blur-xl transition-all duration-500 hover:-translate-y-1 hover:border-accent/50 hover:shadow-card-hover">
                <span
                  aria-hidden="true"
